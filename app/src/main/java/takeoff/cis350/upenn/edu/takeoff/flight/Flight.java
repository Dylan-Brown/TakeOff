...
public class Flight implements Serializable {
    ...
    public boolean isDirectFlight = false;
    public double cost = 99999.99;             // in USD

    public int duration = 0;                   // duration of the Flight in minutes
    public int numOfConnections = 0;           // number of one-way connections

    // these variables are for the departing flight
    public String departureCityCode = "";      // XYZ
    public String departureDate = "";          // YYYY-MM-DD
    public String departureTime = "";          // HH-MM
    public String arrivalCityCode = "";        // XYZ
    public String arrivalDate = "";            // YYYY-MM-DD
    public String arrivalTime = "";            // HH-MM
