...
public class SearchParameters {
     ...
     */
    protected void changeRefundable (boolean r) {this.refundable = r;}
     ...
     */
     protected void changeCFlight (int n) {maxConFlight = n;}
    ...
    protected int getMaxConFlight() {return maxConFlight;}
}
//radio button
